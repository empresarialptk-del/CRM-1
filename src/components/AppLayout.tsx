...
import { Phone, Users, LogOut, Headphones, Activity, Kanban, History, Search, X, TrendingDown, Settings, MapPin, ClipboardList, Home, ShieldCheck, Gem, CalendarDays, Package } from "lucide-react";
    ...
    <div className="min-h-screen flex bg-muted/30">
      <aside className={`w-64 bg-sidebar text-sidebar-foreground flex flex-col relative ${isVisitor ? "select-none" : ""}`}>
        ...
        <nav className="flex-1 p-3 overflow-y-auto space-y-0.5">
          ...
          <NavLink to="/pedidos" className={({ isActive }) => `${navItem} ${isActive ? active : ""}`}>
